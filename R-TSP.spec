...
Version  : 1.1.8
Release  : 28
URL      : https://cran.r-project.org/src/contrib/TSP_1.1-8.tar.gz
Source0  : https://cran.r-project.org/src/contrib/TSP_1.1-8.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1579884135
