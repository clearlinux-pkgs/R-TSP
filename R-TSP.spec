...
Version  : 1.1.9
Release  : 29
URL      : https://cran.r-project.org/src/contrib/TSP_1.1-9.tar.gz
Source0  : https://cran.r-project.org/src/contrib/TSP_1.1-9.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1582304685
